...
class Year2023Day19Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2023Day19().part1(Self.input).debugDescription, "489392")
  }

  func testPart2() {
    XCTAssertEqual(Year2023Day19().part2(Self.input).debugDescription, "0")
  }

  static var input: String {
    """
    fxr{x>387:R,a<752:R,s>1381:fb,sn}
