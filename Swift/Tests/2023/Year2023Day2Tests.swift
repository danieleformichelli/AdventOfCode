...
class Year2023Day2Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2023Day2().part1(Self.input).debugDescription, "2795")
  }

  func testPart2() {
    XCTAssertEqual(Year2023Day2().part2(Self.input).debugDescription, "75561")
  }
