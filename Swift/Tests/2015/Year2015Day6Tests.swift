...
class Year2015Day6Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2015Day6().part1(Self.input).debugDescription, "543903")
  }

  func testPart2() {
    XCTAssertEqual(Year2015Day6().part2(Self.input).debugDescription, "14687245")
  }
