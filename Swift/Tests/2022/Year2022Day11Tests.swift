...
class Year2022Day11Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2022Day11().part1(Self.input).debugDescription, "117640")
  }

  func testPart2() {
    XCTAssertEqual(Year2022Day11().part2(Self.input).debugDescription, "30616425600")
  }
