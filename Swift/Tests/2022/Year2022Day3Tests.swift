...
class Year2022Day3Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2022Day3().part1(Self.input).debugDescription, "7903")
  }

  func testPart2() {
    XCTAssertEqual(Year2022Day3().part2(Self.input).debugDescription, "2548")
  }
