...
class Year2022Day15Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2022Day15().part1(Self.input).debugDescription, "4876693")
  }

  func testPart2() {
    XCTAssertEqual(Year2022Day15().part2(Self.input).debugDescription, "")
  }
