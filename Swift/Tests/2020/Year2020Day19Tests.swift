//
//  Year2020Day19Tests.swift
//  Tests
//
//  Created by Daniele Formichelli on 19/12/20.
...
class Year2020Day19Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2020Day19().part1(Self.input).debugDescription, "272")
  }

  func testPart2() {
    XCTAssertEqual(Year2020Day19().part2(Self.input).debugDescription, "374")
  }
