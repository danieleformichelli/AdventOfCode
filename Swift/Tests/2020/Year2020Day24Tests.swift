//
//  Year2020Day24Tests.swift
//  Tests
//
//  Created by Daniele Formichelli on 24/12/20.
...
class Year2020Day24Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2020Day24().part1(Self.input).debugDescription, "438".debugDescription)
  }

  func testPart2() {
    XCTAssertEqual(Year2020Day24().part2(Self.input).debugDescription, "4038")
  }
