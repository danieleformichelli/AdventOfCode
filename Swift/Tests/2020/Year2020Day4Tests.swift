//
//  Year2020Day4Tests.swift
//  Tests
//
//  Created by Daniele Formichelli on 04/12/2020.
...
class Year2020Day4Tests: XCTestCase {
  func testPart1() {
    XCTAssertEqual(Year2020Day4().part1(Self.input).debugDescription, "226")
  }

  func testPart2() {
    XCTAssertEqual(Year2020Day4().part2(Self.input).debugDescription, "160")
  }
