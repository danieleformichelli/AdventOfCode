...
object Day19 {
     ...
     */
    fun part1(opCodes: List<String>): Int {
        return day19Helper(opCodes, IntArray(6))
    }
    ...
    */
    fun part2(opCodes: List<String>): Int {
        val registers = IntArray(6)
        registers[0] = 1
        return day19Helper(opCodes, registers)
    }
    ...
    private fun parseInput(opCodes: List<String>): Pair<Int, List<Day16.OpCodeAndInputs>> {
        ...
        for (i in 1 until opCodes.size) {
            val opCodeAndInputsSplit = opCodes[i].split(" ")
            val opCodeAndInputs = Day16.OpCodeAndInputs(Day16.OpCode.fromString(opCodeAndInputsSplit[0]), opCodeAndInputsSplit[1].toInt(), opCodeAndInputsSplit[2].toInt(), opCodeAndInputsSplit[3].toInt())
            opCodesAndInputs.add(opCodeAndInputs)
        }

        return Pair(ipRegister, opCodesAndInputs)
    }
}