package com.formichelli.adventofcode.year_2017.day7
...
fun main(args: Array<String>) {
    ...
    // find the only program that is not part of notAtBottomPrograms
    input.forEach {
        val program = it.split(" ")[0]
        if (!notAtBottomPrograms.contains(program)) {
            println(program)
            return
        }
    }
