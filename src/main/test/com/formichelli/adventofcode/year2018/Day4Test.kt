...
class Day4Test(private val part1Result: Int, private val part2Result: Int, private val records: List<String>) {
    companion object {
        @JvmStatic
        ...
        fun data(): Collection<Array<Any>> {
            return listOf(
                    ...
                    arrayOf(140932, 51232, Utils.readLinesFromFile("year2018/day4input.txt"))
            )
        }
    }
    ...
    @Test
    fun part1() {
        Assert.assertEquals("The most sleeping guard multiplied by the most sleeping minute is $part1Result", part1Result, Day4.part1(records))
    }

    @Test
    fun part2() {
        Assert.assertEquals("$part2Result is the only claim that does not overlap", part2Result, Day4.part2(records))
    }
}